...
void MoonlanderHelper::writeToFile(std::vector<double>& solving_times_adaptive,
    ...
    std::ofstream file("plotting_data/adaptive_gridding_timings.csv");
    if (file.is_open()){
...
void MoonlanderHelper::writeToFile(
    ...
    std::ofstream file1("plotting_data/adaptive_gridding_sparsities_jac.csv");
    if (file1.is_open()){
    ...
    std::ofstream file2("plotting_data/adaptive_gridding_sparsities_hess.csv");
    if (file2.is_open()){
